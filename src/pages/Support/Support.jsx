...
const Rainfall = React.lazy(() =>
  import("../../components/animations/Rainfall")
);
const SuccessModal = React.lazy(() =>
  import("../../components/modals/SuccessModal")
);
const Navbar = React.lazy(() => import("../../components/navbar/Navbar"));
const SectionTitle = React.lazy(() =>
  import("../../components/texts/SectionTitle")
);
const InputGroup = React.lazy(() =>
  import("../../components/inputs/InputGroup")
);
              ...
              <div className="flex gap-10 xxs:flex-wrap md:flex-nowrap xxs:items-center sm:my-5 sm:px-16 px-6 sm:py-12 py-4 w-full bg-white  box-shadow rounded-2xl">
                ...
                >
                  ...
                  <Textarea
                    ...
                    classLabel={`font-poppins font-normal text-[20px] leading-[30.8px]`}
                    classInput={
                      "bg-transparent h-[100px] border-b-2 border-primary  placeholder-gray-500 p-1"
                    }

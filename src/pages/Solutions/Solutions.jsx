            ...
            <div className={`${layout.section}`}>
              ...
              >
                  ...
                  <CardText>
                    ...
                    <br />
                    <p>
                      Découvrez l&apos;avenir des études cliniques avec notre
                      logiciel unique conçu pour l&apos;<b>eCRF</b> et{" "}
                      <b>l&apos;ePRO</b>. Grâce à son{" "}
                      <strong>ergonomie simplifiée</strong>, des{" "}
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      à son strict minimum, rendant ainsi notre logiciel facile
                      à apprendre et à utiliser. Cette approche facilite
                      l&apos;adhésion des investigateurs et des patients,
                      augmentant ainsi l&apos;efficacité de vos études.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      Notre politique de{" "}
                      <strong>
                        nombre illimité d&apos;utilisateurs finaux
                      </strong>{" "}
                      inclus dans le prix de la licence vous permet de garder le
                      contrôle total de vos coûts, tout en bénéficiant
                      d&apos;une accessibilité sans restriction.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      à tous les appareils - ordinateurs, tablettes, et
                      smartphones. Ainsi, vous et votre équipe pouvez accéder à
                      vos études à tout moment, où que vous soyez.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      études, comme l&apos;ajout d&apos;une page de CRF, vous
                      donnant ainsi la liberté de vous adapter aux changements
                      et aux imprévus.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      2010, en France et à l&apos;étranger, vous pouvez nous
                      faire confiance pour votre prochaine étude clinique. Notre
                      expérience et notre expertise font de nous un partenaire
              ...
              >
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      qui permet au médecin investigateur d&apos;envoyer
                      directement une demande de consentement via l&apos;eCRF
                      avant d&apos;inclure son patient dans l&apos;étude. Cette
                      technologie moderne et pratique révolutionne le processus
                      de consentement dans les études cliniques.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <br />
                    <p>
                      La signature e-Consent dans EOL est basée sur une
                      signature dite « de niveau simple » selon eIDAS (règlement
                      n° 910/2014/UE, adopté le 23 juillet 2014) et utilise le
                  ...
                  <CardText>
                    ...
                    <br />
                    <p>
                      Que vous l&apos;utilisiez seul ou intégré à l&apos;eCRF,
                      l&apos;eConsent est conçu pour simplifier le travail du
                      moniteur tout en garantissant la <strong>sécurité</strong>{" "}
                      et la <strong>confidentialité</strong> des données. De
                      plus, il offre une flexibilité accrue avec des options de
                      consentement en face-à-face ou à distance par signature
                      SMS ou Mail.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <ul>
                      ...
                      <li>
                        👉 <strong>Simplicité :</strong> Un code unique permet
                        de relier le dossier du patient au consentement.
                      </li>
                      <li>
                        👉 <strong>Contrôle à distance :</strong> Le moniteur
                        peut vérifier la procédure sans se déplacer sur le
                        centre.
                      </li>
                      <li>
                  ...
                  <CardText>
                    ...
                    <br />
                    <p>
                      L&APOS;eConsent a été conçu pour s&apos;adapter à toutes
                      les contraintes de votre étude. Il est{" "}
                      ...
                      circuit des signatures, avec la signature du médecin en
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      permet d&apos;inclure à la fois des patients avec
                      consentement papier ou électronique. Cela vous offre une
                      flexibilité maximale pour répondre aux besoins de votre
                      étude.
                    </p>
                  </CardText>
              ...
              >
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      modernes pour créer une solution qui s&apos;adapte à vos
                      besoins tout en restant facile à utiliser et abordable.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <br />
                    <p>
                      EOL© est bâti sur un modèle 100% internet. Tous ses
                      modules, de la phase de conception à la livraison, en
                      passant par la randomisation, le monitoring, le
                      Data-Management et l&apos;administration, sont accessibles
                      par internet. Peu importe où vous êtes, tant que vous avez
                      une connexion Internet, vous avez accès à EOL©.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      Nous stockons chaque nouvelle étude de façon indépendante
                      et sécurisée sur notre plateforme mutualisée
                      d&apos;hébergement d&apos;études cliniques, agréée
                      Hébergement de données de santé en France par notre
                      partenaire OVH. Cette approche garantit la{" "}
                      <strong>confidentialité</strong> et la{" "}
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      disponibilité et de sécurité optimum. Vous pouvez accéder
                      à vos données 24h/24 et 7j/7, en toute tranquillité.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <ul>
                      ...
                      <li>
                        👉 <strong>Simplicité et rapidité :</strong> Mise en
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      les nouveaux enjeux et problématiques de la recherche
              ...
              >
                  ...
                  <CardText>
                    <h2>
                      {" "}
                      🏆 RANDOMIZER for CLINICAL TRIAL : l&apos;outil ultime
                    ...
                    <p>
                      ...
                      <strong>de manière complètement autonome</strong> vos
                      listes de patients sous Excel. Et le meilleur ? Il
                      n&apos;y a <strong>aucune limite</strong> à la quantité de
                  ...
                  <CardText>
                    ...
                    <p>
                      Prenez de l&apos;avance dès aujourd&apos;hui en
                      téléchargeant notre application. Vous pouvez la trouver
                      sur l’AppStore en utilisant des mots clés tels que{" "}
                      <strong>Medsharing, Randomization, Randomizer</strong>...
                      ou directement depuis la page de notre site consacrée à la{" "}
                  ...
                  <CardText>
                    ...
                    <p>
                      Nous avons conçu cette application pour qu&apos;elle soit
                      à la fois <strong>simple et pratique à utiliser</strong>.
                      Elle s’intègre parfaitement dans la gestion de tous types
                      d’études, qu&apos;elles soient petites ou grandes, simples
                      ou complexes.
                    </p>
                  </CardText>
                  ...
                  <CardText>
                    ...
                    <p>
                      ...
                      un nombre illimité de patients dans autant d’études que
                      vous le souhaitez. Ne vous préoccupez plus des limites et
                      concentrez-vous sur ce qui compte vraiment : la
                      réalisation de vos études cliniques.
                    </p>
                  </CardText>

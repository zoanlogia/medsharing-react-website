...
export const stats = [
  ...
  },
  {
    id: "stats-3",
    title:
      "Un module de consentement électronique compatible avec l'eCRF. La signature électronique est sécurisée par OTP. L'arc moniteur contrôle à distance via un code unique pour préserver l'anonymat.",
    icon: s2,
    value: "e-Pro",
  },
  {
